...
type CustomerService interface {
	GetList(ctx context.Context, in *CustListParams, opts ...client.CallOption) (*CustDto, error)
}
...
func (c *customerService) GetList(ctx context.Context, in *CustListParams, opts ...client.CallOption) (*CustDto, error) {
...
type CustomerHandler interface {
	GetList(context.Context, *CustListParams, *CustDto) error
}

func RegisterCustomerHandler(s server.Server, hdlr CustomerHandler, opts ...server.HandlerOption) error {
	type customer interface {
		GetList(ctx context.Context, in *CustListParams, out *CustDto) error
	}
...
func (h *customerHandler) GetList(ctx context.Context, in *CustListParams, out *CustDto) error {
